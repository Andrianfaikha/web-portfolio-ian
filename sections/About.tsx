...
export default function About() {
  return (
    <section
      id="about"
      className="bg-black py-20 md:py-36 px-4 sm:px-6 md:px-12 border-t border-zinc-900 overflow-hidden"
    >
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
          ...
          >
            <div className="relative w-[80%] sm:w-[70%] lg:w-full aspect-[3/4] bg-zinc-950 border border-zinc-900 grayscale contrast-125 group overflow-hidden">
              <Image
                src="/ian_profile.png"
                alt="Ian profile"
                fill
