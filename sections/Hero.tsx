...
export default function Hero() {
  ...
  return (
    <section
      ref={containerRef}
      id="home"
      className="relative min-h-screen bg-black flex items-center justify-center overflow-hidden py-24 md:py-32 px-6 md:px-12"
    >
      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
        ...
        <motion.div
          ...
          className="col-span-12 lg:col-span-6 relative flex items-center justify-center h-[400px] sm:h-[50vh] lg:h-[70vh] w-full"
        >
          ...
          <div className="relative w-[75%] h-[90%] md:w-[65%] md:h-[95%] lg:w-[80%] lg:h-[90%] bg-zinc-950 overflow-hidden grayscale contrast-125 border border-zinc-900 shadow-2xl group">
            <Image
              src="/ian_profile.png"
              alt="Ian Profile"
              fill
          ...
          <div className="absolute bottom-2 left-6 lg:left-0 bg-black/85 border border-zinc-800/80 backdrop-blur px-5 py-3 flex flex-col space-y-1">
        ...
        <div className="col-span-12 lg:col-span-6 relative flex flex-col justify-center h-full select-none mt-6 lg:mt-0">
          <motion.div
            style={{ y: textY }}
            ref={textRef}
          ...
          >
            ...
            <h1 className="font-syne font-extrabold tracking-tight text-white mb-8">
              <div className="overflow-hidden block py-1 min-h-[2.5rem] sm:min-h-[3rem] lg:h-[6vw]">
                <span className="reveal-text block text-3xl sm:text-5xl md:text-6xl lg:text-[5vw] leading-none uppercase font-light">
                  {"HELLO, I'M"}
                </span>
              </div>
              <div className="overflow-hidden block py-1 min-h-[4rem] sm:min-h-[5.5rem] lg:h-[11vw] mt-2">
                <span className="reveal-text block text-6xl sm:text-8xl md:text-9xl lg:text-[9.5vw] font-black leading-none text-white tracking-tighter">
                  IAN.
                </span>
              </div>
            </h1>
            ...
            <div className="space-y-3 font-syne font-bold text-[18px] sm:text-[22px] md:text-[26px] tracking-wide text-zinc-400 mt-2 uppercase border-l-2 border-zinc-800 pl-6 py-2">
            ...
            {/* Short Bio Block */}
            <p className="mt-8 max-w-md text-xs md:text-sm text-zinc-500 leading-relaxed tracking-wider font-sans">
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-10 flex flex-col items-center space-y-2 pointer-events-none">
        ...
        <motion.div
          ...
          className="w-[1px] h-10 bg-zinc-800"
        />
      </div>
    </section>
  );
